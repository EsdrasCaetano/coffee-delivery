...
export function ConfirmationSection() {
    ...
    const formattedDeliveryProce = formatMoney(DELIVERY_PRICE)
    ...
    return (
        <ConfirmationSectionContainer>
            ...
            <div>
                ...
                <RegularText >R$: {formattedDeliveryProce}</RegularText>
            </div>
            <div>
                <RegularText weight="700" color="subtitle" size="l">Total de itens</RegularText>
